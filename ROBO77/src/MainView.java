...
public class MainView extends JPanel{
   ...
   JButton b1,b2;
   MainView() {
       back=Toolkit.getDefaultToolkit().getImage("c:\\javaDev\\77.png");
       // 배치위치
       la1=new JLabel("아이디");
       la2=new JLabel("비밀번호");
       ...
       b1 = new JButton(new ImageIcon("c:\\javaDev\\Login.png"));
       b2 = new JButton(new ImageIcon("c:\\javaDev\\Login.png"));
